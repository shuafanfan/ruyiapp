...
{
    private $create_fields = array('title', 'city_id', 'cate_id', 'area_id', 'business_id', 'user_id', 'is_shop', 'text1', 'text2', 'text3', 'num1', 'num2', 'select1', 'select2', 'select3', 'select4', 'select5', 'urgent_date', 'top_date', 'photo', 'contact', 'mobile', 'qq', 'addr', 'views', 'money','lng', 'lat');
    private $edit_fields = array('title', 'city_id', 'cate_id', 'area_id', 'business_id', 'user_id', 'is_shop', 'text1', 'text2', 'text3', 'num1', 'num2', 'select1', 'select2', 'select3', 'select4', 'select5', 'urgent_date', 'top_date', 'photo', 'contact', 'mobile', 'qq', 'addr', 'views','money', 'lng', 'lat');
        ...
        if ($subscribe_id = (int) $subscribe_id) {
			...
			if($detail = $obj->find($subscribe_id)){
				if($obj->delete($subscribe_id)){
					$this->baoSuccess('删除成功！', U('life/subscribe'));
				}
			}else{
				$this->baoError('没找到');
			}
